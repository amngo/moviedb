        ...
        {sortedCredits.map((credit, index) => {
          ...
          const previousYear =
            index > 0 && sortedCredits[index - 1].release_date
              ? new Date(sortedCredits[index - 1].release_date).getFullYear()
              : 'TBA';
            ...
            <div
              ...
              ref={(el) => {
                if (index === 0 || currentYear !== previousYear) {
                  yearRefs.current[currentYear.toString()] = el;
                }
              }}
            >
              <TimelineItem
                ...
                id={credit.id}
                date={
                  credit.release_date ? formatDate(credit.release_date) : ''
                }
                year={currentYear.toString()}
                showYearSeparator={index === 0 || currentYear !== previousYear}
                title={credit.title}
